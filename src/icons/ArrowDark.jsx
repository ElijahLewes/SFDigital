...
export default function ArrowAngularTopRightDark() { TODO: /*ENSURE THAT THERE ARE TWO VERSIONS OF ARROWLIGHT AND THE RIGHT VERSION IS CALLED WHEN IN A SPECIFIC MODE*/
  return (
    <div className="w-[35px] h-[35px] rounded-full bg-[var(--Charcoal)] flex items-center justify-center p-[2px]">
      <svg
        width="30"
        height="30"
        viewBox="0 0 25 25"
